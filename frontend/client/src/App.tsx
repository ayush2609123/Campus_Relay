...
export default function App() {
  ...
  return (
    <Routes>
      {/* Public auth routes — if already logged in, go to dashboard */}
      <Route
        path="/login"
      ...
      {/* App shell wraps public dashboard + protected features */}
      <Route element={<AppShell me={me} />}>
        ...
        {/* Pretty paths that FORCE the correct kind via redirect */}
        <Route
          path="/carpool"
          element={
            <RequireAuth authed={authed}>
              <Navigate to="/find-trips?kind=carpool" replace />
            </RequireAuth>
          }
        />
        <Route
          ...
          element={
            <RequireAuth authed={authed}>
              <Navigate to="/find-trips?kind=shuttle" replace />
            </RequireAuth>
          }
        />

        {/* Main search page (reads ?kind=carpool|shuttle and filters accordingly) */}
        <Route
          path="/find-trips"
          element={
            <RequireAuth authed={authed}>
        ...
        <Route
          path="/go/carpool"
          element={<Navigate to="/find-trips?kind=carpool" replace />}
        />
        <Route
          path="/go/shuttle"
          element={<Navigate to="/find-trips?kind=shuttle" replace />}
        />
      </Route>
